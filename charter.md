# Technical Charter (the "Charter") for Lockness a Series of LF Projects, LLC
...
a. The mission of the Project is to establish an ecosystem for key management protocols including key generation algorithms, digital signatures and data storage environments for any type of cryptography.

b. The scope of the Project includes collaborative development under the licenses of the Project supporting the mission, including documentation, testing, integration and the creation of other artifacts that aid the development, deployment, operation or adoption of the open source project.
...
b. Except as described in Section 7.c., all contributions to the Project are subject to the following:
   ...
   i. All new inbound code contributions to the Project must be made using either:
      - Apache License, Version 2.0 available at http://www.apache.org/licenses/LICENSE-2.0 (the "Apache License").
      - Dual MIT-or-Apache-2.0 license (meaning that any contribution shall comply with both licenses, "Dual License"), MIT License is available at https://opensource.org/license/mit ("MIT License"), and the Apache License.

   ii. All new inbound code contributions must also be accompanied by a Developer Certificate of Origin (http://developercertificate.org) sign-off in the source code system that is submitted through a TSC-approved contribution process which will bind the authorized contributor and, if not self-employed, their employer to the applicable license;

   iii. All outbound code will be made available under the Apache License in the case of code contributed only under the Apache License or, in the case of code contributed under the Dual License, either the Apache License or the MIT License, at the option of the user.
