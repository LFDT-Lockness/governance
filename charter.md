...
1. **Mission and Scope of the Project**
   1. The mission of the Project is to establish an ecosystem for key management protocols including key generation algorithms, digital signatures and data storage environments for any type of cryptography. 
   2. The scope of the Project includes collaborative development under the licenses of the Project supporting the mission, including documentation, testing, integration and the creation of other artifacts that aid the development, deployment, operation or adoption of the open source project.
2. **Technical Steering Committee**
   ...
   3. TSC projects generally will involve Contributors and Maintainers. The TSC may adopt or modify roles so long as the roles are documented in the MAINTAINERS file. Unless otherwise documented: 
      ...
      3. A Contributor may become a Maintainer by a two-thirds vote of all of the existing Maintainers. A Maintainer may be removed by a two-thirds vote of all of the other existing Maintainers.
...
3. **TSC Voting**
   ...
   3. Except as provided in Sections 2.c.iii., 2.f., 7.c., and 8.a, decisions by vote at a meeting require a majority vote of those in attendance, provided quorum is met. Decisions made by electronic vote without a meeting require a majority vote of all voting members of the TSC.
...
7. **Intellectual Property Policy**
   ...
   2. Except as described in Section 7.c., all contributions to the Project are subject to the following: 
      1. All new inbound code contributions to the Project must be made using either:
         * Apache License, Version 2.0 available at [http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0)  (the “Apache License”). 
         * Dual MIT-or-Apache-2.0 license (meaning that any contribution shall comply with both licenses, “Dual License”), MIT License is available at [https://opensource.org/license/mit](https://opensource.org/license/mit) (“MIT License”), and the Apache License.
      ...
      3. All outbound code will be made available under the Apache License in the case of code contributed only under the Apache License or, in the case of code contributed under the Dual License, either the Apache License or the MIT License, at the option of the user.
